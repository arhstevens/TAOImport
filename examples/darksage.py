...
class DARKSAGEConverter(tao.Converter):
    ...
    def __init__(self, *args, **kwargs):
        src_fields_dict = OrderedDict([
               ...
               ('DiskScaleRadius', {
                        'type': np.float32,
                        'label': "MMW Scale Radius",
                        'description': "Exponential scale radius from spin parameter (Mo, Mao & White 1998)",
                        'group': "Galaxy Properties",
                        'units': "Mpc/h",
                        'order': -1,
                        }),
               ('CoolingScaleRadius', {
                        ...
                        'description': "Exponential scale radius used in determining how freshly cooled gas is distributed",
                        'group': "Galaxy Properties",
                        'units': "Mpc/h",
                        'order': 22,
                        }),
               ('StellarDiscScaleRadius', {
                        'type': np.float32,
                        'label': "Stellar Disc Scale Radius",
                        'description': "Exponential scale radius used for stars when required for prescriptions",
                        'group': "Galaxy Properties",
                        'units': "Mpc/h",
                        'order': -1,
                        }), 
               ...
               ('dZGas', {
                ...
                ('TimeSinceLastMajorMerger', {
                        'type': np.float32,
                        'label': "Time since Last Major Merger",
                        'description': "Look-back time of last major merger",
                        'group': "Galaxy Properties",
                        'units': "Myr/h",
                        'order': 33,
                         }),
    ...
    def get_mapping_table(self):
        ...
        mapping = {'posx': 'Pos_x',
                   ...
                   'diskscaleradius': 'CoolingScaleRadius',
